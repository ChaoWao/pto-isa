...
class F_cross_entropyKernel {
public:
    __aicore__ inline F_cross_entropyKernel() {}
...
extern "C" __global__ __aicore__ void F_cross_entropy_kernel(GM_ADDR input, GM_ADDR output) {
    F_cross_entropyKernel op;
