...
class attention_relative_positionKernel {
public:
    __aicore__ inline attention_relative_positionKernel() {}
...
extern "C" __global__ __aicore__ void attention_relative_position_kernel(GM_ADDR input, GM_ADDR output) {
    attention_relative_positionKernel op;
