...
class sdpa_with_scaleKernel {
public:
    __aicore__ inline sdpa_with_scaleKernel() {}
...
extern "C" __global__ __aicore__ void sdpa_with_scale_kernel(GM_ADDR input, GM_ADDR output) {
    sdpa_with_scaleKernel op;
