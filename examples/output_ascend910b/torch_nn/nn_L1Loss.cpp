...
class nn_L1LossKernel {
public:
    __aicore__ inline nn_L1LossKernel() {}
...
private:
    ...
    __aicore__ inline void Compute() {
        ...
        // FUSED (4 ops): TLOAD; TLOAD; TSUB; TABS
        // TLOAD: Operation
        // TLOAD: Operation
...
extern "C" __global__ __aicore__ void nn_L1Loss_kernel(GM_ADDR input, GM_ADDR output) {
    nn_L1LossKernel op;
