...
// FUSED LOOP (4 ops): self=TLOAD(input,0,0); ln_val=TLOG(self); result=TMULS(ln_val,1.4426950408889634f); output=TSTORE(result,0,0)
float32x4_t _vs0 = vdupq_n_f32(1.4426950408889634f);
